...
public class CoffeeControllerTest
{
    ...
    public class CoffeeControllerTests
    {
        ...
        public async Task GetBrewCoffee_Returns418_OnApril1st()
        {
            ...
            var onApril1st = new DateTime(2024, 4, 1);
        ...
        public async Task GetBrewCoffee_Returns200_WithBrewCoffeeDto()
        {
            ...
            mockService.Setup(s => s.GetInfo()).Returns(new BrewCoffeeDto { Message = "Your coffee is ready!" });
            ...
            Assert.AreEqual("Your coffee is ready!", dto.Message);
        }
    }
}